...
module.exports = function(grunt){
	...
	grunt.initConfig({
	 ...
	    },
		jshint: {
			files: ["../js/**/*.js"],
			options: {
				predef: ["document", "console", "$", "event", "alert", "XMLHttpRequest", "setTimeout", "require", "module"],
				...
				globals: ["Handlebars", "carInventory", "templates"]
			}
		},
		copy: {
			jquery: {
	...
	grunt.registerTask('default', ['jshint', 'copy', 'sass', 'watch', 'cssmin', 'browserify']);
};